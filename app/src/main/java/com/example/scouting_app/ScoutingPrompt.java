...
public class ScoutingPrompt extends AppCompatActivity {
	...
	public void submit(View v) {
		...
		Thread thread = new Thread(() -> {
			...
			//load the shit into ScoutingEntry
			ScoutingEntry scoutingEntry = new ScoutingEntry(uid, psw, cyclesInfo, teleOpBallsInfo, autoBallsInfo,
					didClimbInfo, RouletteWheelByRotationsInfo, RouletteWheelByColorInfo,
					commentsInfo, teamNumInfo, gameNumInfo);
			try {
				//send data to server pls work
	...
	public void toggleTheme() {
		//not yet implemented but will switch from regular dark-mode to GreenBlitzMode
